...
CREATE TABLE `device` (
  ...
  `gateway_no` int(11) DEFAULT NULL COMMENT '호스트키',
  `device_type` int(11) DEFAULT NULL COMMENT 'zwave, ir, wallpad, sip....',
  `nickname` varchar(50) DEFAULT NULL,
  `created_time` timestamp NULL DEFAULT NULL,
  `lastmodified_time` timestamp NULL DEFAULT NULL,
  `active` int(11) DEFAULT NULL,
  `device_seq` int(11) DEFAULT NULL,
  PRIMARY KEY (`no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='호스트에 등록된 기기들 연결정보';
