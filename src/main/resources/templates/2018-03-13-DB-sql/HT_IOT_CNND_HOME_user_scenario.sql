...
--
-- Table structure for table `user_scenario`
--
...
CREATE TABLE `user_scenario` (
  ...
  `scenario_nos` int(10) unsigned NOT NULL,
  `username` varchar(100) NOT NULL,
  `type` varchar(100) NOT NULL,
  `active` int(11) DEFAULT NULL,
  `scenario_action_no` int(11) NOT NULL,
  `scenario_trigger_no` int(11) NOT NULL,
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='유저 시나리오 예약정보';
