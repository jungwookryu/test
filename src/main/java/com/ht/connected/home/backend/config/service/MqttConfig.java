...
//                    //gateway service
//                    if (Category.gateway.name().equals(topicSplited[2].toString())) {
...
//                    }
//                    //zwave service
//                    if (Category.zwave.name().equals(topicSplited[2].toString())) {
//                        ZwaveRequest zwaveRequest = new ZwaveRequest(topicSplited);
...
//                        }
//                    }
//                    if (Category.ir.name().equals(topicSplited[2].toString())) {
//                        ZwaveRequest zwaveRequest = new ZwaveRequest(topicSplited);
//                        LOGGER.info("messageArrived: Topic=" + topic + ", host=");
//                        zwaveService.subscribe(zwaveRequest, payload);
//                    }
